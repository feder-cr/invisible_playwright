...
from invisible_playwright._pw._impl._sync_base import (
    EventContextManager,
    SyncBase,
    SyncContextManager,
    mapping,
...
class Frame(SyncBase):
    ...
    def wait_for_selector(
        ...
        **Usage**
        ...
        ```py
        from invisible_playwright._pw.sync_api import sync_playwright, Playwright
...
class Playwright(SyncBase):
    ...
    def chromium(self) -> "BrowserType":
        ...
        # Rejects with a line that explains it, instead of an AttributeError.
...
class PageAssertions(SyncBase):
    ...
    def to_have_title(
        ...
        **Usage**
        ...
        ```py
        import re
        from invisible_playwright._pw.sync_api import expect
