...
from invisible_playwright._pw._impl._assertions import (
    APIResponseAssertions as APIResponseAssertionsImpl,
)
from invisible_playwright._pw._impl._assertions import LocatorAssertions as LocatorAssertionsImpl
from invisible_playwright._pw._impl._assertions import PageAssertions as PageAssertionsImpl
from invisible_playwright._pw._impl._async_base import (
    AsyncBase,
    AsyncContextManager,
    AsyncEventContextManager,
    mapping,
)
from invisible_playwright._pw._impl._browser import Browser as BrowserImpl
from invisible_playwright._pw._impl._browser_context import BrowserContext as BrowserContextImpl
from invisible_playwright._pw._impl._browser_type import BrowserType as BrowserTypeImpl
from invisible_playwright._pw._impl._cdp_session import CDPSession as CDPSessionImpl
from invisible_playwright._pw._impl._clock import Clock as ClockImpl
from invisible_playwright._pw._impl._console_message import ConsoleMessage as ConsoleMessageImpl
from invisible_playwright._pw._impl._credentials import Credentials as CredentialsImpl
from invisible_playwright._pw._impl._debugger import Debugger as DebuggerImpl
from invisible_playwright._pw._impl._dialog import Dialog as DialogImpl
from invisible_playwright._pw._impl._disposable import Disposable as DisposableImpl
from invisible_playwright._pw._impl._download import Download as DownloadImpl
from invisible_playwright._pw._impl._element_handle import ElementHandle as ElementHandleImpl
from invisible_playwright._pw._impl._errors import Error
from invisible_playwright._pw._impl._fetch import APIRequest as APIRequestImpl
from invisible_playwright._pw._impl._fetch import APIRequestContext as APIRequestContextImpl
from invisible_playwright._pw._impl._fetch import APIResponse as APIResponseImpl
from invisible_playwright._pw._impl._file_chooser import FileChooser as FileChooserImpl
from invisible_playwright._pw._impl._form_data import FormData
from invisible_playwright._pw._impl._frame import Frame as FrameImpl
from invisible_playwright._pw._impl._helper import to_milliseconds
from invisible_playwright._pw._impl._input import Keyboard as KeyboardImpl
from invisible_playwright._pw._impl._input import Mouse as MouseImpl
from invisible_playwright._pw._impl._input import Touchscreen as TouchscreenImpl
from invisible_playwright._pw._impl._js_handle import JSHandle as JSHandleImpl
from invisible_playwright._pw._impl._locator import FrameLocator as FrameLocatorImpl
from invisible_playwright._pw._impl._locator import Locator as LocatorImpl
from invisible_playwright._pw._impl._network import Request as RequestImpl
from invisible_playwright._pw._impl._network import Response as ResponseImpl
from invisible_playwright._pw._impl._network import Route as RouteImpl
from invisible_playwright._pw._impl._network import WebSocket as WebSocketImpl
from invisible_playwright._pw._impl._network import WebSocketRoute as WebSocketRouteImpl
from invisible_playwright._pw._impl._page import Page as PageImpl
from invisible_playwright._pw._impl._page import Worker as WorkerImpl
from invisible_playwright._pw._impl._playwright import Playwright as PlaywrightImpl
from invisible_playwright._pw._impl._screencast import Screencast as ScreencastImpl
from invisible_playwright._pw._impl._selectors import Selectors as SelectorsImpl
from invisible_playwright._pw._impl._tracing import Tracing as TracingImpl
from invisible_playwright._pw._impl._video import Video as VideoImpl
from invisible_playwright._pw._impl._web_error import WebError as WebErrorImpl
from invisible_playwright._pw._impl._web_storage import WebStorage as WebStorageImpl
...
class Frame(AsyncBase):
    ...
    async def wait_for_selector(
        ...
        **Usage**
        ...
        ```py
        import asyncio
        from invisible_playwright._pw.async_api import async_playwright, Playwright
...
class Credentials(AsyncBase):
    ...
    async def install(self) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.install())
    ...
    async def delete(self, id: str) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.delete(id=id))
...
class WebStorage(AsyncBase):

    async def items(self) -> typing.List[NameValue]:
        """WebStorage.items
        ...
        return mapping.from_impl_list(await self._impl_obj.items())

    async def get_item(self, name: str) -> typing.Optional[str]:
        """WebStorage.get_item
        ...
        return mapping.from_maybe_impl(await self._impl_obj.get_item(name=name))
    ...
    async def set_item(self, name: str, value: str) -> None:
        ...
        return mapping.from_maybe_impl(
            await self._impl_obj.set_item(name=name, value=value)
        )
    ...
    async def remove_item(self, name: str) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.remove_item(name=name))
    ...
    async def clear(self) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.clear())
...
class PageAssertions(AsyncBase):
    ...
    async def to_have_title(
        ...
        **Usage**
        ...
        ```py
        import re
        from invisible_playwright._pw.async_api import expect
